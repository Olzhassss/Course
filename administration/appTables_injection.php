<?php
	...
	if ($_POST['role'] == "teachers") {
		...
		$sql2 = "SELECT `id`, `name`, `surname`, `gender`, `email`, `app_date` FROM appletree_personnel.app_teachers";
	}
	...
	elseif ($_POST['role'] == "students") {
		...
		(`column_name` = 'name' OR `column_name` = 'surname' OR `column_name` = 'gender' OR `column_name` = 'email' OR `column_name` = 'app_date') ORDER BY `ORDINAL_POSITION`";
		$sql2 = "SELECT `id`, `name`, `surname`, `gender`, `email`, `app_date` FROM appletree_personnel.app_students";
	}
