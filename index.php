...
<div class="container main" >
	...
	<div class="form-wrapper pl-3 pt-3 pb-3 pr-3">
		...
		<form method="post" action="?" style="height: 200px;">
			<h2>For new applicants! Please choose your role and press 'Submit!'</h2> 
			<input type="submit" name="submit_button_teacher" value="I am a teacher" class="mt-3 ml-1 mr-1" style="width:30%; height: 15%;">
			<input type="submit" name="submit_button_student" value="I am a student" class="mt-3 ml-1 mr-1" style="width:30%;height: 15%;">
			<br>
 		</form>
 	</div>
</div>
